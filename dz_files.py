...
with open(os.path.join(os.getcwd(), "recipes.txt"), 'r', encoding='utf-8') as f_recipes:
    cook_book = {}
    for file_line in f_recipes:
...
list_shop2 = get_shop_list_by_dishes(['Запеченный картофель', 'Омлет', 'Фахитос'], 7)
